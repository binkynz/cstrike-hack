...
struct signatures {
	...
	uintptr_t m_client_dll;
	uintptr_t m_engine_dll;
	uintptr_t m_server_dll;
	uintptr_t m_gameoverlayrenderer_dll;
	uintptr_t m_vgui2_dll;
	uintptr_t m_vguimatsurface_dll;
	uintptr_t m_studiorender_dll;
	uintptr_t m_localize_dll;
	uintptr_t m_datacache_dll;
	uintptr_t m_materialsystem_dll;
